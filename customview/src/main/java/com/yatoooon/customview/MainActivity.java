...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ObjectAnimator topAnimator = ObjectAnimator.ofFloat(cameraView, "topFlipDeg", -45);
        topAnimator.setDuration(1500);
        ObjectAnimator flipAnimator = ObjectAnimator.ofFloat(cameraView, "rotateDeg", 270);
        flipAnimator.setDuration(1500);
        ObjectAnimator bottomAnimator = ObjectAnimator.ofFloat(cameraView, "bottomFlipDeg", 45);
